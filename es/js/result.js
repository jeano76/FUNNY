...
const resultData = {
  ...
  INTP: {
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ León 🦁", "ENFJ Golden Retriever 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP Búho! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "León", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP Búho 🦉", "INFP Caballito de mar 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ León! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "Loro", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    shareText: "나는 ENTP Loro! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    ...
    compatibleTypes: ["ENTP Loro 🦜", "ENFP Delfín 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ Panda! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "Caballito de mar", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP Caballito de mar! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
  ...
  ENFP: {
    ...
    shareText: "나는 ENFP Delfín! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
  ...
  ISFJ: {
    ...
    compatibleTypes: ["ESTP Guepardo 🐆", "ESFP Pavo real 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ Ciervo! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP Perezoso 🦥", "INFP Caballito de mar 🦭"],
  ...
  ESFJ: {
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP Perezoso 🦥", "ISTP Gato 🐱"],
  ...
  ISFP: {
    ...
    shareText: "나는 ISFP Perezoso! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
  ...
  ESFP: {
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ Castor 🦫", "ISFJ Ciervo 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP Pavo real! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

...
const resultData = {
  ...
  INTJ: {
    ...
    koreanRatio: "2.1%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["ENFP โลมา 🐬", "ENTP นกแก้ว 🦜"],
    famousExamples: ["일론 머스크", "니체", "아이작 뉴턴"],
    shareText: "나는 INTJ เสือ! 고독한 전략가 🐯 당신의 성격 유형은?"
  },
  INTP: {
    name: "นกฮูก", emoji: "🦉", title: "논리적 탐구자",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ สิงโต 🦁", "ENFJ โกลเด้นรีทรีฟเวอร์ 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP นกฮูก! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "สิงโต", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP นกฮูก 🦉", "INFP ม้าน้ำ 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ สิงโต! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "นกแก้ว", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.2%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["INTJ เสือ 🐯", "INFJ แพนด้า 🐼"],
    famousExamples: ["레오나르도 다빈치", "벤자민 프랭클린"],
    shareText: "나는 ENTP นกแก้ว! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    name: "แพนด้า", emoji: "🐼", title: "신비로운 통찰자",
    ...
    compatibleTypes: ["ENTP นกแก้ว 🦜", "ENFP โลมา 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ แพนด้า! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "ม้าน้ำ", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP ม้าน้ำ! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
    name: "โกลเด้นรีทรีฟเวอร์", emoji: "🐕", title: "다정한 리더",
    group: "외교형 (NF)",
    ...
    compatibleTypes: ["INFP ม้าน้ำ 🦭", "INTP นกฮูก 🦉"],
    famousExamples: ["오프라 윈프리", "버락 오바마"],
    shareText: "나는 ENFJ โกลเด้นรีทรีฟเวอร์! 다정한 리더 🐕 당신의 성격 유형은?"
  },
  ENFP: {
    name: "โลมา", emoji: "🐬", title: "자유로운 영감가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 ENFP โลมา! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
    name: "บีเวอร์", emoji: "🦫", title: "성실의 아이콘",
    ...
    compatibleTypes: ["ESFP นกยูง 🦚", "ENFP โลมา 🐬"],
    famousExamples: ["워런 버핏", "앤젤라 메르켈"],
    shareText: "나는 ISTJ บีเวอร์! 한국인 1위 성실의 아이콘 🦫 당신의 성격 유형은?"
  },
  ISFJ: {
    name: "กวาง", emoji: "🦌", title: "따뜻한 수호자",
    group: "관리자형 (SJ)",
    ...
    compatibleTypes: ["ESTP เสือชีตา 🐆", "ESFP นกยูง 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ กวาง! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    name: "หมาป่า", emoji: "🐺", title: "엄격한 관리자",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP ตัวเต็มตัว 🦥", "INFP ม้าน้ำ 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ หมาป่า! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
    name: "ช้าง", emoji: "🐘", title: "사교적인 돌봄이",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP ตัวเต็มตัว 🦥", "ISTP แมว 🐱"],
    famousExamples: ["테일러 스위프트", "빌 클린턴"],
    shareText: "나는 ESFJ ช้าง! 사교적인 돌봄이 🐘 당신의 성격 유형은?"
  },
  // ---- 탐험가형 SP ----
  ISTP: {
    name: "แมว", emoji: "🐱", title: "시크한 장인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ หมาป่า 🐺", "ENTJ สิงโต 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP แมว! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "ตัวเต็มตัว", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ หมาป่า 🐺", "ESFJ ช้าง 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP ตัวเต็มตัว! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
    name: "เสือชีตา", emoji: "🐆", title: "스릴 추구자",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "4.3%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ISFJ กวาง 🦌", "ISTJ บีเวอร์ 🦫"],
    famousExamples: ["도널드 트럼프", "어니스트 헤밍웨이"],
    shareText: "나는 ESTP เสือชีตา! 스릴 추구자 🐆 당신의 성격 유형은?"
  },
  ESFP: {
    name: "นกยูง", emoji: "🦚", title: "화려한 연예인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ บีเวอร์ 🦫", "ISFJ กวาง 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP นกยูง! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

...
const resultData = {
  ...
  INTJ: {
    ...
    koreanRatio: "2.1%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["ENFP Усны гахай 🐬", "ENTP Тоть шувуу 🦜"],
    famousExamples: ["일론 머스크", "니체", "아이작 뉴턴"],
    shareText: "나는 INTJ Бар! 고독한 전략가 🐯 당신의 성격 유형은?"
  },
  INTP: {
    name: "Шар шувуу", emoji: "🦉", title: "논리적 탐구자",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ Арслан 🦁", "ENFJ Алтан дахь нохой 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP Шар шувуу! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "Арслан", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP Шар шувуу 🦉", "INFP Далайн морь 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ Арслан! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "Тоть шувуу", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.2%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["INTJ Бар 🐯", "INFJ Панда 🐼"],
    famousExamples: ["레오나르도 다빈치", "벤자민 프랭클린"],
    shareText: "나는 ENTP Тоть шувуу! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    name: "Панда", emoji: "🐼", title: "신비로운 통찰자",
    ...
    compatibleTypes: ["ENTP Тоть шувуу 🦜", "ENFP Усны гахай 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ Панда! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "Далайн морь", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP Далайн морь! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
    name: "Алтан дахь нохой", emoji: "🐕", title: "다정한 리더",
    group: "외교형 (NF)",
    ...
    compatibleTypes: ["INFP Далайн морь 🦭", "INTP Шар шувуу 🦉"],
    famousExamples: ["오프라 윈프리", "버락 오바마"],
    shareText: "나는 ENFJ Алтан дахь нохой! 다정한 리더 🐕 당신의 성격 유형은?"
  },
  ENFP: {
    name: "Усны гахай", emoji: "🐬", title: "자유로운 영감가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 ENFP Усны гахай! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
    name: "Минж", emoji: "🦫", title: "성실의 아이콘",
    ...
    compatibleTypes: ["ESFP Тогос 🦚", "ENFP Усны гахай 🐬"],
    famousExamples: ["워런 버핏", "앤젤라 메르켈"],
    shareText: "나는 ISTJ Минж! 한국인 1위 성실의 아이콘 🦫 당신의 성격 유형은?"
  },
  ISFJ: {
    name: "Буга", emoji: "🦌", title: "따뜻한 수호자",
    group: "관리자형 (SJ)",
    ...
    compatibleTypes: ["ESTP Гепард 🐆", "ESFP Тогос 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ Буга! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    name: "Чоно", emoji: "🐺", title: "엄격한 관리자",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP Залхуу амьтан 🦥", "INFP Далайн морь 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ Чоно! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
    name: "Заан", emoji: "🐘", title: "사교적인 돌봄이",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP Залхуу амьтан 🦥", "ISTP Муур 🐱"],
    famousExamples: ["테일러 스위프트", "빌 클린턴"],
    shareText: "나는 ESFJ Заан! 사교적인 돌봄이 🐘 당신의 성격 유형은?"
  },
  // ---- 탐험가형 SP ----
  ISTP: {
    name: "Муур", emoji: "🐱", title: "시크한 장인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ Чоно 🐺", "ENTJ Арслан 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP Муур! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "Залхуу амьтан", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ Чоно 🐺", "ESFJ Заан 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP Залхуу амьтан! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
    name: "Гепард", emoji: "🐆", title: "스릴 추구자",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "4.3%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ISFJ Буга 🦌", "ISTJ Минж 🦫"],
    famousExamples: ["도널드 트럼프", "어니스트 헤밍웨이"],
    shareText: "나는 ESTP Гепард! 스릴 추구자 🐆 당신의 성격 유형은?"
  },
  ESFP: {
    name: "Тогос", emoji: "🦚", title: "화려한 연예인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ Минж 🦫", "ISFJ Буга 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP Тогос! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

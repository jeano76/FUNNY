...
const resultData = {
  ...
  INTP: {
    ...
    shareText: "나는 INTP Owl! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP Owl 🦉", "INFP Sea Horse 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ Lion! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "Parrot", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    shareText: "나는 ENTP Parrot! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
  ...
  INFP: {
    ...
    shareText: "나는 INFP Sea Horse! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
  ...
  ENFP: {
    ...
    shareText: "나는 ENFP Dolphin! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
    name: "Beaver", emoji: "🦫", title: "성실의 아이콘",
    ...
    compatibleTypes: ["ESFP Peacock 🦚", "ENFP Dolphin 🐬"],
    famousExamples: ["워런 버핏", "앤젤라 메르켈"],
    shareText: "나는 ISTJ Beaver! 한국인 1위 성실의 아이콘 🦫 당신의 성격 유형은?"
  },
  ISFJ: {
    name: "Deer", emoji: "🦌", title: "따뜻한 수호자",
    group: "관리자형 (SJ)",
    ...
    compatibleTypes: ["ESTP Cheetah 🐆", "ESFP Peacock 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ Deer! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP Sloth 🦥", "INFP Sea Horse 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ Wolf! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
    name: "Elephant", emoji: "🐘", title: "사교적인 돌봄이",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP Sloth 🦥", "ISTP Cat 🐱"],
    famousExamples: ["테일러 스위프트", "빌 클린턴"],
    shareText: "나는 ESFJ Elephant! 사교적인 돌봄이 🐘 당신의 성격 유형은?"
  },
  // ---- 탐험가형 SP ----
  ISTP: {
    name: "Cat", emoji: "🐱", title: "시크한 장인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ Wolf 🐺", "ENTJ Lion 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP Cat! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "Sloth", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ Wolf 🐺", "ESFJ Elephant 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP Sloth! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
  ...
  ESFP: {
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ Beaver 🦫", "ISFJ Deer 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP Peacock! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

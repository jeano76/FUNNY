...
const resultData = {
  // ---- 분석형 NT ----
  INTJ: {
    name: "Tigris", emoji: "🐯", title: "고독한 전략가",
    ...
    koreanRatio: "2.1%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["ENFP Delphinus 🐬", "ENTP Psittacus 🦜"],
    famousExamples: ["일론 머스크", "니체", "아이작 뉴턴"],
    shareText: "나는 INTJ Tigris! 고독한 전략가 🐯 당신의 성격 유형은?"
  },
  INTP: {
    name: "Noctua", emoji: "🦉", title: "논리적 탐구자",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ Leo 🦁", "ENFJ Canis Aureus 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP Noctua! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "Leo", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP Noctua 🦉", "INFP Hippocampus 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ Leo! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "Psittacus", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.2%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["INTJ Tigris 🐯", "INFJ Panda 🐼"],
    famousExamples: ["레오나르도 다빈치", "벤자민 프랭클린"],
    shareText: "나는 ENTP Psittacus! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    ...
    compatibleTypes: ["ENTP Psittacus 🦜", "ENFP Delphinus 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ Panda! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "Hippocampus", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP Hippocampus! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
    name: "Canis Aureus", emoji: "🐕", title: "다정한 리더",
    group: "외교형 (NF)",
    ...
    compatibleTypes: ["INFP Hippocampus 🦭", "INTP Noctua 🦉"],
    famousExamples: ["오프라 윈프리", "버락 오바마"],
    shareText: "나는 ENFJ Canis Aureus! 다정한 리더 🐕 당신의 성격 유형은?"
  },
  ENFP: {
    name: "Delphinus", emoji: "🐬", title: "자유로운 영감가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 ENFP Delphinus! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
  ...
  ISFJ: {
    ...
    compatibleTypes: ["ESTP Acinonyx 🐆", "ESFP Pavo 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ Cervus! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    name: "Lupus", emoji: "🐺", title: "엄격한 관리자",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP Piger 🦥", "INFP Hippocampus 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ Lupus! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
    name: "Elephas", emoji: "🐘", title: "사교적인 돌봄이",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP Piger 🦥", "ISTP Felis 🐱"],
    famousExamples: ["테일러 스위프트", "빌 클린턴"],
    shareText: "나는 ESFJ Elephas! 사교적인 돌봄이 🐘 당신의 성격 유형은?"
  },
  // ---- 탐험가형 SP ----
  ISTP: {
    name: "Felis", emoji: "🐱", title: "시크한 장인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ Lupus 🐺", "ENTJ Leo 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP Felis! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "Piger", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ Lupus 🐺", "ESFJ Elephas 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP Piger! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
    name: "Acinonyx", emoji: "🐆", title: "스릴 추구자",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "4.3%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ISFJ Cervus 🦌", "ISTJ Castor 🦫"],
    famousExamples: ["도널드 트럼프", "어니스트 헤밍웨이"],
    shareText: "나는 ESTP Acinonyx! 스릴 추구자 🐆 당신의 성격 유형은?"
  },
  ESFP: {
    name: "Pavo", emoji: "🦚", title: "화려한 연예인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ Castor 🦫", "ISFJ Cervus 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP Pavo! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

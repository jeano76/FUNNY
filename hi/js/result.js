...
const resultData = {
  ...
  INTJ: {
    ...
    koreanRatio: "2.1%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["ENFP डॉल्फिन 🐬", "ENTP तोता 🦜"],
    famousExamples: ["일론 머스크", "니체", "아이작 뉴턴"],
    shareText: "나는 INTJ बाघ! 고독한 전략가 🐯 당신의 성격 유형은?"
  },
  INTP: {
    name: "उल्लू", emoji: "🦉", title: "논리적 탐구자",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ शेर 🦁", "ENFJ गोल्डन रिट्रीवर 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP उल्लू! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "शेर", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP उल्लू 🦉", "INFP समुद्र घोड़ा 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ शेर! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "तोता", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.2%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["INTJ बाघ 🐯", "INFJ पांडा 🐼"],
    famousExamples: ["레오나르도 다빈치", "벤자민 프랭클린"],
    shareText: "나는 ENTP तोता! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    name: "पांडा", emoji: "🐼", title: "신비로운 통찰자",
    ...
    compatibleTypes: ["ENTP तोता 🦜", "ENFP डॉल्फिन 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ पांडा! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "समुद्र घोड़ा", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP समुद्र घोड़ा! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
    name: "गोल्डन रिट्रीवर", emoji: "🐕", title: "다정한 리더",
    group: "외교형 (NF)",
    ...
    compatibleTypes: ["INFP समुद्र घोड़ा 🦭", "INTP उल्लू 🦉"],
    famousExamples: ["오프라 윈프리", "버락 오바마"],
    shareText: "나는 ENFJ गोल्डन रिट्रीवर! 다정한 리더 🐕 당신의 성격 유형은?"
  },
  ENFP: {
    name: "डॉल्फिन", emoji: "🐬", title: "자유로운 영감가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 ENFP डॉल्फिन! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
    name: "ऊदबिलाव", emoji: "🦫", title: "성실의 아이콘",
    ...
    compatibleTypes: ["ESFP मोर 🦚", "ENFP डॉल्फिन 🐬"],
    famousExamples: ["워런 버핏", "앤젤라 메르켈"],
    shareText: "나는 ISTJ ऊदबिलाव! 한국인 1위 성실의 아이콘 🦫 당신의 성격 유형은?"
  },
  ISFJ: {
    name: "हिरण", emoji: "🦌", title: "따뜻한 수호자",
    group: "관리자형 (SJ)",
    ...
    compatibleTypes: ["ESTP चीता 🐆", "ESFP मोर 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ हिरण! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    name: "भेड़िया", emoji: "🐺", title: "엄격한 관리자",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP सुस्ती 🦥", "INFP समुद्र घोड़ा 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ भेड़िया! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
    name: "हाथी", emoji: "🐘", title: "사교적인 돌봄이",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP सुस्ती 🦥", "ISTP बिल्ली 🐱"],
    famousExamples: ["테일러 스위프트", "빌 클린턴"],
    shareText: "나는 ESFJ हाथी! 사교적인 돌봄이 🐘 당신의 성격 유형은?"
  },
  // ---- 탐험가형 SP ----
  ISTP: {
    name: "बिल्ली", emoji: "🐱", title: "시크한 장인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ भेड़िया 🐺", "ENTJ शेर 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP बिल्ली! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "सुस्ती", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ भेड़िया 🐺", "ESFJ हाथी 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP सुस्ती! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
    name: "चीता", emoji: "🐆", title: "스릴 추구자",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "4.3%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ISFJ हिरण 🦌", "ISTJ ऊदबिलाव 🦫"],
    famousExamples: ["도널드 트럼프", "어니스트 헤밍웨이"],
    shareText: "나는 ESTP चीता! 스릴 추구자 🐆 당신의 성격 유형은?"
  },
  ESFP: {
    name: "मोर", emoji: "🦚", title: "화려한 연예인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ ऊदबिलाव 🦫", "ISFJ हिरण 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP मोर! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

...
const resultData = {
  ...
  INTJ: {
    ...
    koreanRatio: "2.1%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["ENFP Дельфин 🐬", "ENTP Попугай 🦜"],
    famousExamples: ["일론 머스크", "니체", "아이작 뉴턴"],
    shareText: "나는 INTJ Тигр! 고독한 전략가 🐯 당신의 성격 유형은?"
  },
  INTP: {
    name: "Сова", emoji: "🦉", title: "논리적 탐구자",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ Лев 🦁", "ENFJ Золотистый ретривер 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP Сова! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "Лев", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP Сова 🦉", "INFP Морской конек 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ Лев! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "Попугай", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.2%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["INTJ Тигр 🐯", "INFJ Панда 🐼"],
    famousExamples: ["레오나르도 다빈치", "벤자민 프랭클린"],
    shareText: "나는 ENTP Попугай! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    ...
    compatibleTypes: ["ENTP Попугай 🦜", "ENFP Дельфин 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ Панда! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "Морской конек", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP Морской конек! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
    name: "Золотистый ретривер", emoji: "🐕", title: "다정한 리더",
    group: "외교형 (NF)",
    ...
    compatibleTypes: ["INFP Морской конек 🦭", "INTP Сова 🦉"],
    famousExamples: ["오프라 윈프리", "버락 오바마"],
    shareText: "나는 ENFJ Золотистый ретривер! 다정한 리더 🐕 당신의 성격 유형은?"
  },
  ENFP: {
    name: "Дельфин", emoji: "🐬", title: "자유로운 영감가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 ENFP Дельфин! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
    name: "Бобер", emoji: "🦫", title: "성실의 아이콘",
    ...
    compatibleTypes: ["ESFP Павлин 🦚", "ENFP Дельфин 🐬"],
    famousExamples: ["워런 버핏", "앤젤라 메르켈"],
    shareText: "나는 ISTJ Бобер! 한국인 1위 성실의 아이콘 🦫 당신의 성격 유형은?"
  },
  ISFJ: {
    name: "Олень", emoji: "🦌", title: "따뜻한 수호자",
    group: "관리자형 (SJ)",
    ...
    compatibleTypes: ["ESTP Гепард 🐆", "ESFP Павлин 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ Олень! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    name: "Волк", emoji: "🐺", title: "엄격한 관리자",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP Ленивец 🦥", "INFP Морской конек 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ Волк! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
    name: "Слон", emoji: "🐘", title: "사교적인 돌봄이",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "12.3%",
    worldRarityRank: "★ 흔한 유형",
    compatibleTypes: ["ISFP Ленивец 🦥", "ISTP Кошка 🐱"],
    famousExamples: ["테일러 스위프트", "빌 클린턴"],
    shareText: "나는 ESFJ Слон! 사교적인 돌봄이 🐘 당신의 성격 유형은?"
  },
  // ---- 탐험가형 SP ----
  ISTP: {
    name: "Кошка", emoji: "🐱", title: "시크한 장인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ Волк 🐺", "ENTJ Лев 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP Кошка! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "Ленивец", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ Волк 🐺", "ESFJ Слон 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP Ленивец! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
  ...
  ESFP: {
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ Бобер 🦫", "ISFJ Олень 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP Павлин! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};

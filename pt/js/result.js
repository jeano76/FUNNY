...
const resultData = {
  ...
  INTJ: {
    ...
    koreanRatio: "2.1%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["ENFP Golfinho 🐬", "ENTP Papagaio 🦜"],
    famousExamples: ["일론 머스크", "니체", "아이작 뉴턴"],
    shareText: "나는 INTJ Tigre! 고독한 전략가 🐯 당신의 성격 유형은?"
  },
  INTP: {
    name: "Coruja", emoji: "🦉", title: "논리적 탐구자",
    group: "분석형 (NT)",
    ...
    koreanRatio: "3.3%",
    worldRarityRank: "★★★★ 희귀",
    compatibleTypes: ["ENTJ Leão 🦁", "ENFJ Golden Retriever 🐕"],
    famousExamples: ["알버트 아인슈타인", "빌 게이츠"],
    shareText: "나는 INTP Coruja! 논리적 탐구자 🦉 당신의 성격 유형은?"
  },
  ENTJ: {
    name: "Leão", emoji: "🦁", title: "타고난 리더",
    group: "분석형 (NT)",
    ...
    koreanRatio: "1.8%",
    worldRarityRank: "★★★★★ 최희귀",
    compatibleTypes: ["INTP Coruja 🦉", "INFP Cavalo-marinho 🦭"],
    famousExamples: ["스티브 잡스", "마가렛 대처"],
    shareText: "나는 ENTJ Leão! 타고난 리더 🦁 당신의 성격 유형은?"
  },
  ENTP: {
    name: "Papagaio", emoji: "🦜", title: "발명가형 토론러",
    group: "분석형 (NT)",
    ...
    shareText: "나는 ENTP Papagaio! 발명가형 토론러 🦜 당신의 성격 유형은?"
  },
  // ---- 외교형 NF ----
  INFJ: {
    ...
    compatibleTypes: ["ENTP Papagaio 🦜", "ENFP Golfinho 🐬"],
    famousExamples: ["마틴 루서 킹", "넬슨 만델라"],
    shareText: "나는 INFJ Panda! 전 세계 가장 희귀한 유형 🐼 당신의 성격 유형은?"
  },
  INFP: {
    name: "Cavalo-marinho", emoji: "🦭", title: "이상적인 몽상가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 INFP Cavalo-marinho! 이상적인 몽상가 🦭 당신의 성격 유형은?"
  },
  ENFJ: {
    ...
    compatibleTypes: ["INFP Cavalo-marinho 🦭", "INTP Coruja 🦉"],
    famousExamples: ["오프라 윈프리", "버락 오바마"],
    shareText: "나는 ENFJ Golden Retriever! 다정한 리더 🐕 당신의 성격 유형은?"
  },
  ENFP: {
    name: "Golfinho", emoji: "🐬", title: "자유로운 영감가",
    group: "외교형 (NF)",
    ...
    shareText: "나는 ENFP Golfinho! 자유로운 영감가 🐬 당신의 성격 유형은?"
  },
  // ---- 관리자형 SJ ----
  ISTJ: {
    name: "Castor", emoji: "🦫", title: "성실의 아이콘",
    ...
    compatibleTypes: ["ESFP Pavão 🦚", "ENFP Golfinho 🐬"],
    famousExamples: ["워런 버핏", "앤젤라 메르켈"],
    shareText: "나는 ISTJ Castor! 한국인 1위 성실의 아이콘 🦫 당신의 성격 유형은?"
  },
  ISFJ: {
    name: "Veado", emoji: "🦌", title: "따뜻한 수호자",
    group: "관리자형 (SJ)",
    ...
    compatibleTypes: ["ESTP Guepardo 🐆", "ESFP Pavão 🦚"],
    famousExamples: ["테레사 수녀", "비욘세"],
    shareText: "나는 ISFJ Veado! 따뜻한 수호자 🦌 당신의 성격 유형은?"
  },
  ESTJ: {
    name: "Lobo", emoji: "🐺", title: "엄격한 관리자",
    group: "관리자형 (SJ)",
    ...
    koreanRatio: "8.7%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISFP Preguiça 🦥", "INFP Cavalo-marinho 🦭"],
    famousExamples: ["힐러리 클린턴", "산드라 오"],
    shareText: "나는 ESTJ Lobo! 엄격한 관리자 🐺 당신의 성격 유형은?"
  },
  ESFJ: {
  ...
  ISTP: {
    ...
    koreanRatio: "5.4%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ESTJ Lobo 🐺", "ENTJ Leão 🦁"],
    famousExamples: ["클린트 이스트우드", "어윈 슈뢰딩거"],
    shareText: "나는 ISTP Gato! 시크한 장인 🐱 당신의 성격 유형은?"
  },
  ISFP: {
    name: "Preguiça", emoji: "🦥", title: "자유로운 예술가",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.8%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ESTJ Lobo 🐺", "ESFJ Elefante 🐘"],
    famousExamples: ["마이클 잭슨", "아비게일 브레슬린"],
    shareText: "나는 ISFP Preguiça! 자유로운 예술가 🦥 당신의 성격 유형은?"
  },
  ESTP: {
    name: "Guepardo", emoji: "🐆", title: "스릴 추구자",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "4.3%",
    worldRarityRank: "★★★ 보통",
    compatibleTypes: ["ISFJ Veado 🦌", "ISTJ Castor 🦫"],
    famousExamples: ["도널드 트럼프", "어니스트 헤밍웨이"],
    shareText: "나는 ESTP Guepardo! 스릴 추구자 🐆 당신의 성격 유형은?"
  },
  ESFP: {
    name: "Pavão", emoji: "🦚", title: "화려한 연예인",
    group: "탐험가형 (SP)",
    ...
    koreanRatio: "8.5%",
    worldRarityRank: "★★ 보통",
    compatibleTypes: ["ISTJ Castor 🦫", "ISFJ Veado 🦌"],
    famousExamples: ["아델", "미국 마릴린 먼로"],
    shareText: "나는 ESFP Pavão! 화려한 연예인 🦚 당신의 성격 유형은?"
  }
};
